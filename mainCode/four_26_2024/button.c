...
//extern volatile enum {COUNTERCLOCKWISE, CLOCKWISE} servo_mode;
//
///**
...
//    int threePushed = 0;
//    int fourPushed =0;
//    int a = GPIO_PORTE_DATA_R;
//    onePushed = GPIO_PORTE_DATA_R & 0b00000001;
//    twoPushed =  GPIO_PORTE_DATA_R & 0b00000010;
//    threePushed = GPIO_PORTE_DATA_R & 0b00000100;
//    fourPushed = GPIO_PORTE_DATA_R & 0b00001000;
//
//        if (fourPushed == 0b00000000){
//            if (servo_mode == CLOCKWISE){
//                servo_move(0xC090);
//            } else{
//                servo_move(0x4F90);
//            }
//
//        } else if( threePushed == 0b00000000){
//            if (servo_mode == COUNTERCLOCKWISE){
//                servo_mode = CLOCKWISE;
//            } else{
//                servo_mode = COUNTERCLOCKWISE;
//            }
//        }else if( twoPushed == 0b00000000){
//            if (servo_mode == COUNTERCLOCKWISE){
//                servo_move(TIMER1_TBMATCHR_R-0x389);
//            } else{
//                servo_move(TIMER1_TBMATCHR_R+0x389);
//            }
//        }else if( onePushed == 0b00000000){
//            if (servo_mode == COUNTERCLOCKWISE){
//
//                servo_move(TIMER1_TBMATCHR_R-0xB5);
//            } else{
//                servo_move(TIMER1_TBMATCHR_R+0xB5);
//            }
//        }else{
